...
_QuantLib.Hours_swigconstant(_QuantLib)
Hours = _QuantLib.Hours

_QuantLib.Minutes_swigconstant(_QuantLib)
Minutes = _QuantLib.Minutes

_QuantLib.Seconds_swigconstant(_QuantLib)
Seconds = _QuantLib.Seconds

_QuantLib.Milliseconds_swigconstant(_QuantLib)
Milliseconds = _QuantLib.Milliseconds

_QuantLib.Microseconds_swigconstant(_QuantLib)
...
_QuantLib.ShiftedLognormal_swigconstant(_QuantLib)
ShiftedLognormal = _QuantLib.ShiftedLognormal

_QuantLib.Normal_swigconstant(_QuantLib)
...
class OptionletStripper1(StrippedOptionletBase):
    ...
    def __init__(self, *args):
        this = _QuantLib.new_OptionletStripper1(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
